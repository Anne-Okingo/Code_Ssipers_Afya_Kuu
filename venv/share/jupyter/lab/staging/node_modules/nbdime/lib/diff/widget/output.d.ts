 ...
 */
export declare class OutputPanel extends DiffPanel<OutputDiffModel> {
    /**
     *
     */
    constructor({ parent: parentModel, editorClasses, rendermime, ...others }: ICellDiffViewOptions<OutputDiffModel>);
    /**
