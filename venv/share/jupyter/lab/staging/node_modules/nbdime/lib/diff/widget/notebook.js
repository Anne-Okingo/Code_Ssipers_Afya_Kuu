...
import { CHUNK_PANEL_CLASS, ADDED_CHUNK_PANEL_CLASS, REMOVED_CHUNK_PANEL_CLASS, } from './common';
 ...
 * NotebookDiffWidget
 */
export class NotebookDiffWidget extends DiffPanel {
    ...
    init() {
        ...
        work = work.then(() => {
            if (model.metadata) {
                this.addWidget(new MetadataDiffWidget({
                ...
                return new Promise(resolve => {
                    if (chunk.length === 1 && !(chunk[0].added || chunk[0].deleted)) {
                        ...
                        for (let cell of chunk) {
                            ...
                            target.addWidget(new CellDiffWidget({
                                model: cell,
                                rendermime,
                                mimetype: model.mimetype,
                                editorFactory: this._editorFactory,
