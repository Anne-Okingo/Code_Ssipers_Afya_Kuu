...
import { StringDiffModel, } from '../../diff/model';
...
import { createCheckbox, UNCHANGED_MERGE_CLASS, ONEWAY_LOCAL_CLASS, ONEWAY_REMOTE_CLASS, TWOWAY_ADDITION_CLASS, TWOWAY_DELETION_CLASS, MERGE_CLASSES, } from './common';
...
export class CellMergeWidget extends MergePanel {
        ...
        */
        ...
        if (model.local === null ||
            ...
            if (outputsChanged || hasEntries(model.merged.outputs)) {
                ...
                let view = new RenderableOutputsMergeView(mergedOut, MERGE_CLASSES, this._rendermime, baseOut, remoteOut, localOut, this._viewOptions.showBase);
    ...
    _createClearOutputToggle() {
        let { checkbox, widget } = createCheckbox(this.model.clearOutputs, this._trans.__('Clear outputs'));
    ...
    _createDeleteToggle() {
        let { checkbox, widget } = createCheckbox(this.model.deleteCell, this._trans.__('Delete cell'));
