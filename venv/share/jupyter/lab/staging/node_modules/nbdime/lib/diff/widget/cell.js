...
import { StringDiffModel, OutputDiffModel, } from '../model';
import { DIFF_CLASSES, ADDED_DIFF_CLASS, DELETED_DIFF_CLASS, TWOWAY_DIFF_CLASS, UNCHANGED_DIFF_CLASS, CHUNK_PANEL_CLASS, ADDED_CHUNK_PANEL_CLASS, REMOVED_CHUNK_PANEL_CLASS, } from './common';
 ...
 */
export class CellDiffWidget extends DiffPanel {
    /**
     *
     */
    ...
    static createView({ model, parent, editorClasses, rendermime, editorFactory, translator, ...viewOptions }) {
        ...
        if (model instanceof StringDiffModel) {
            ...
            if (model.collapsible) {
                view = new CollapsiblePanel(inner, model.collapsibleHeader, model.startCollapsed);
            }
            else {
                view = new Panel();
