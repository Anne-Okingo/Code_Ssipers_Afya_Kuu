 ...
 */
export class MetadataDiffWidget extends DiffPanel {
    constructor(options) {
        super(options);
    ...
    init() {
        ...
        if (!model.unchanged) {
            ...
            let view = createNbdimeMergeView({
                remote: model,
            ...
            if (model.collapsible) {
                view = new CollapsiblePanel(view, model.collapsibleHeader, model.startCollapsed);
            }
            this.addWidget(view);
        }
    }
