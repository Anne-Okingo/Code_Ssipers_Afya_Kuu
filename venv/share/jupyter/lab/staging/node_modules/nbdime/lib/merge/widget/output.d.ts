...
export declare class RenderableOutputsMergeView extends DragDropPanel {
     ...
     *
     */
    constructor(merged: nbformat.IOutput[], classes: string[], rendermime: IRenderMimeRegistry, base: nbformat.IOutput[] | null, remote: nbformat.IOutput[] | null, local: nbformat.IOutput[] | null, showBase?: boolean);
    ...
    protected onDragComplete(action: Drag.DropAction): void;
