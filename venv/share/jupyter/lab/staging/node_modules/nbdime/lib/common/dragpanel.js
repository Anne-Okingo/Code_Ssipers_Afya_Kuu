 ...
 */
export function belongsToUs(node, parentClass, parentNode) {
    let candidate = node;
 ...
 */
export function findChild(parent, node) {
 ...
 * of drop class.
 */
export class DragDropPanelBase extends DropPanel {
    /**
 ...
 */
export class DragPanel extends DragDropPanelBase {
    /**
