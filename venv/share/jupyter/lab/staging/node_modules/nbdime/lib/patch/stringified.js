...
import { validateObjectOp, validateSequenceOp, } from '../diff/diffentries';
 ...
 * defaults to true.
 */
export function stringify(values, level, indentFirst = true) {
 ...
 */
export function stringifyAndBlankNull(value) {
 ...
 * objects.
 */
export function patchStringified(base, diff, level) {
    if (level === undefined) {
        level = 0;
    }
 ...
 */
export function patchString(base, diff, level, stringifyPatch) {
    let additions = [];
    let deletions = [];
    let baseIndex = 0;
