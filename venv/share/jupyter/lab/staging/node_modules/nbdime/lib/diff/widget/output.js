...
import { ADDED_DIFF_CLASS, DELETED_DIFF_CLASS, TWOWAY_DIFF_CLASS, UNCHANGED_DIFF_CLASS, ADD_DEL_LABEL_CLASS, } from './common';
 ...
 */
export class OutputPanel extends DiffPanel {
    /**
     *
     */
    ...
    initContainer(view) {
        if (this._model.collapsible) {
            this.container = new CollapsiblePanel(view, this._model.collapsibleHeader, this._model.startCollapsed);
        }
        else {
            this.container = this;
 ...
 */
export class RenderableOutputView extends RenderableDiffView {
