...
function addCommands(app, tracker, rendermime, settings, editorServices, translator) {
     ...
     */
    const serverMissingMsg = trans.__('Unable to query nbdime API. Is the server extension enabled?');
    ...
    commands.addCommand(CommandIDs.diffNotebookCheckpoint, {
        ...
        caption: erroredGen(trans.__('Display nbdiff from checkpoint to currently saved version')),
        isEnabled: baseEnabled,
    ...
    commands.addCommand(CommandIDs.diffNotebookGit, {
        ...
        caption: erroredGen(trans.__('Display nbdiff from git HEAD to currently saved version')),
 ...
 */
async function activateWidgetExtension(app, tracker, rendermime, settingsRegistry, editorServices, translator) {
    ...
    addCommands(app, tracker, rendermime, settings, editorServices, translator ?? nullTranslator);
